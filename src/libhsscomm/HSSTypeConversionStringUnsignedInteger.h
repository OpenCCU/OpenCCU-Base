...
#ifndef _HSSTYPECONVERSIONSTRINGUNSIGNEDINTEGER_H_
#define _HSSTYPECONVERSIONSTRINGUNSIGNEDINTEGER_H_
 ...
 */
class DLLEXPORT HSSTypeConversionStringUnsignedInteger : public HSSTypeConversion  
{
public:
	...
	//! Konstruktor
	HSSTypeConversionStringUnsignedInteger();
	//! Destruktor
	virtual ~HSSTypeConversionStringUnsignedInteger();
...
#endif // _HSSTYPECONVERSIONSTRINGUNSIGNEDINTEGER_H_
