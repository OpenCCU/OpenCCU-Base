...
#ifndef _HSSTYPECONVERSIONCFM_H_
#define _HSSTYPECONVERSIONCFM_H_
...
//! Konvertierung für  für MP3 Funkgong
class DLLEXPORT HSSTypeConversionCfm : public HSSTypeConversion  
{
public:
	...
	//! Konstruktor
	HSSTypeConversionCfm();
	//! Destruktor
	virtual ~HSSTypeConversionCfm();
};
