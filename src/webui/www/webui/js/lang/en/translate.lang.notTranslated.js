jQuery.extend(true, langJSON, {
  "en": {
    ...
    "dlp_LOCK_STATE" : "en* Zustand",
    "dlp_LOCK_STATE_REASON" : "en* Ausgel%F6st durch:",
    "dlp_LOCK_TEACH_IN_STATE" : "en* LOCK_TEACH_IN_STATE",
    "dlp_LAST_LOCK_DRIVE_LOAD" : "en* LAST_LOCK_DRIVE_LOAD",

    "dlpLockState_0" : "en* ubekannt",
    "dlpLockState_1" : "en* verriegelt",
    "dlpLockState_2" : "en* entriegelt",
    //"dlpLockState_3" : "INVALID",
    "dlpLockState_3" : "en* ungültig",
    ...
    "dlpLockStateReason_5" : "en* Motorisch, durch Auto-Relock nach Türzustandsänderung",
    ...
    "dlpLockStateReason_9" : "en* Manuell, von außen",
    "dlpLockStateReason_10" : "en* Manuell, von innen",
    "dlpLockStateReason_11" : "en* Manuell",

    "dlpLockTeachInState_0" : "en* en* Türschloss-Anlern-Prozedur nicht (mehr) aktiv",
    ...
    "dlpLockTeachInState_3" : "en* beide Neutralstellungen vorgemerkt, bereit für Endanschlagsfahrt",
    "dlpLockTeachInState_4" : "en* Anlernfahrt läuft",
    "dlpLockTeachInState_5" : "en* Türschloss-Anlern-Prozedur erfolgreich abgeschlossen (keine Aussage über Parameter-Übertragung)",
    ...
    "dlpLockTeachInState_12" : "en* Türschloss-Anlern-Prozedur Fehler: sonstige",
    ...
    "stringTableDoorLockStateTransceiverLockTargetLevelResetTeachIn" : "en* Türschloss-Anlern-Prozedur zurücksetzen",
    ...
    "stringTableDoorLockStateTransceiverLockTargetLevelTestrunSaveLockUnlock" : "en* Endanschläge prüfen (Fahrt: lock, open) und als Konfiguration speichern",
    "stringTableDoorLockStateTransceiverLockTargetLevelTeachInDriveOpenDoorNeutralUnlocked" : "en* Anlernfahrt (inkl. Schlosslast) starten bei geöffneter Tür\n" +
      "und Schloss in Neutralstellung Entriegelt und als Konfiguration speichern",
    "stringTableDoorLockStateTransceiverLockTargetLevelTeachInDriveOpenDoorNeutralVertical" : "en* Anlernfahrt (inkl. Schlosslast) starten bei geöffneter Tür (entriegelt)\n" +
      "bei Schloss mit Neutralstellung vertical und als Konfiguration speichern",
    "stringTableDoorLockStateTransceiverLockTargetLevelTeachInDriveOpenDoorNeutralHorizontal" : "en* Anlernfahrt (inkl. Schlosslast)starten bei geöffneter Tür (entriegelt)\n" +
      "bei Schloss mit Neutralstellung horizontal und als Konfiguration speichern",
    "stringTableDoorLockStateTransceiverLockTargetLevelLoadCalibrationClosedDoor" : "en* Anlernen der Schlosslast bei geschlossener Tür (Fahrt: lock, unlock)",
    "stringTableDoorLockStateTransceiverLockTargetLevelLoadCalibrationOpenDoor" : "en* Anlernen der Schlosslast bei geöffneter Tür (Fahrt: lock, unlock)",
