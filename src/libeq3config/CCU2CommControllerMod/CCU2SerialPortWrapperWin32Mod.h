...
#ifndef _CCU2SERIALPORTWRAPPERWIN32MOD_H_
#define _CCU2SERIALPORTWRAPPERWIN32MOD_H_
...
class CCU2SerialPortWrapperWin32Mod : public CCU2SerialPortWrapperMod
{
public:
	//! Konstruktor
	CCU2SerialPortWrapperWin32Mod();
	//! Destruktor
	virtual ~CCU2SerialPortWrapperWin32Mod();
	//! �ffnen des Ports
	/*!
